"""
Enhanced FastAPI application for FS Reconciliation Agents API v2.
...
from src.api.v2.routers import exceptions, data_upload, reports, health, logs, auth, settings, metrics, actions, database, workflows
from src.api.v2.middleware import RequestLoggingMiddleware, PerformanceMiddleware
from src.api.v2.websockets import websocket_router
...
app = FastAPI(
    ...
    ## WebSocket Support
    Real-time updates are available via WebSocket connections for live data streaming.
    """,
    version="2.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
...
def custom_openapi():
    ...
    openapi_schema["info"]["x-rate-limit"] = {
        ...
        "documentation": "Check X-RateLimit-* headers for current limits"
    }
